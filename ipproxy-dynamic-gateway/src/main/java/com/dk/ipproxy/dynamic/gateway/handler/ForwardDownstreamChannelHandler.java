...
public class ForwardDownstreamChannelHandler extends ChannelInboundHandlerAdapter {
    private static final Logger logger = LoggerFactory.getLogger(ForwardDownstreamChannelHandler.class);
    private final Channel peerChannel;

    public ForwardDownstreamChannelHandler(Channel peerChannel) {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        if (logger.isDebugEnabled()) {
            ...
            logger.debug("down [{} -> {}] forwarded to {}", srcChannel.remoteAddress(), srcChannel.localAddress(), peerChannel.remoteAddress());
        }
